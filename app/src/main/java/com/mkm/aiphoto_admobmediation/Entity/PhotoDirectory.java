package com.mkm.aiphoto_admobmediation.Entity;

import android.text.TextUtils;

import androidx.annotation.NonNull;

import com.mkm.aiphoto_admobmediation.Picker.FileUtils;
    ...
    public void setPhotos(List<Photo> list) {
        if (list != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (photo == null || !com.mkm.aiphoto_admobmediation.Picker.FileUtils.fileIsExists(photo.getPath())) {
                    list.remove(i);
                } else {
                    i++;
                }
