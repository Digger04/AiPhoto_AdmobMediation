...
class SlantUtils {
    ...
    static Pair<List<SlantLine>, List<SlantArea>> cutAreaWith(SlantArea slantArea, int i, int i2) {
        ...
        for (int i4 = i + 1; i4 > 1; i4--) {
            ...
            SlantLine createLine = createLine(slantArea2, PolishLine.Direction.HORIZONTAL, f - 0.025f, f + 0.025f);
        ...
        while (true) {
            ...
            SlantLine createLine2 = createLine(slantArea3, PolishLine.Direction.VERTICAL, f2 + 0.025f, f2 - 0.025f);
