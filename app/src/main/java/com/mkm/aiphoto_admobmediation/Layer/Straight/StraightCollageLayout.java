...
public abstract class StraightCollageLayout implements PolishLayout {
    ...
    public void addLine(int i, PolishLine.Direction direction, float f) {
        ...
        int i2 = 0;
        step.type = 0;
        if (direction == PolishLine.Direction.VERTICAL) {
            i2 = 1;
        }else if (direction == PolishLine.Direction.CIRCLE) {
...
//            Log.d("fwefew", "dddd:" + canvas);
//            this.steps.add(canvas);
        }
        step.direction = i2;
        step.position = i;
        this.steps.add(step);
...
//    }
    ...
    public TemplateItem Heart() {
        String FRAME_FOLDER = "frame";
        String ASSET_PREFIX = "assets://";

        TemplateItem item = new TemplateItem();
        item.setPreview(ASSET_PREFIX + FRAME_FOLDER + "/" + "frameName");
        ...
        photoItem.getBound().set(0f,0f,0.3333f,1f);
        photoItem.getPointList().add(new PointF(0f,0f));
        photoItem.getPointList().add(new PointF(1f,0f));
        photoItem.getPointList().add(new PointF(1f,1f));
        photoItem.getPointList().add(new PointF(0f,1f));
        photoItems.add(photoItem);

        photoItem = new PhotoItem();
        photoItem.setIndex(1);
        photoItem.getBound().set(0.3333f,0f,0.6666f,1f);
        photoItem.getPointList().add(new PointF(0f,0f));
        photoItem.getPointList().add(new PointF(1f,0f));
        photoItem.getPointList().add(new PointF(1f,1f));
        photoItem.getPointList().add(new PointF(0f,1f));
        ...
        photoItem = new PhotoItem();
        photoItem.setIndex(2);
        photoItem.getBound().set(0.6666f,0f,1f,1f);
        photoItem.getPointList().add(new PointF(0f,0f));
        photoItem.getPointList().add(new PointF(1f,0f));
        photoItem.getPointList().add(new PointF(1f,1f));
        photoItem.getPointList().add(new PointF(0f,1f));
        ...
        Log.d("efwefw", " sizeList: " + photoItems.size());
        item.setPhotoItemList(photoItems);
