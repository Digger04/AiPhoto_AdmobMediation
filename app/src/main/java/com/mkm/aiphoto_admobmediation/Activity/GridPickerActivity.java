...
import com.mkm.aiphoto_admobmediation.Adapter.AlbumAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.ListAlbumAdapter;
import com.mkm.aiphoto_admobmediation.Constants.Constants;
import com.mkm.aiphoto_admobmediation.Interface.OnAlbum;
import com.mkm.aiphoto_admobmediation.Interface.OnListAlbum;
import com.mkm.aiphoto_admobmediation.Model.ImageModel;
...
public class GridPickerActivity extends AppCompatActivity implements View.OnClickListener, OnAlbum, OnListAlbum {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.textViewDone) {
            ...
            Toast.makeText(this, getString(R.string.please_select_at_lease) + " " + this.limitImageMin + " " + getString(R.string.images), Toast.LENGTH_SHORT).show();
        }
    }
...
//        }
    ...
    private void done(ArrayList<String> arrayList) {
        Intent intent = new Intent(this, MKMCollageActivity.class);
