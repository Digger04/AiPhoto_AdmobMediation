...
import com.mkm.aiphoto_admobmediation.Vector.DHANVINE_Vector2D;
...
public class MultiTouchListener implements View.OnTouchListener {
    ...
    private class ScaleGestureListener extends ScaleGestureDetector.SimpleOnScaleGestureListener implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(View view, com.mkm.aiphoto_admobmediation.Vector.ScaleGestureDetector dHANVINE_ScaleGestureDetector) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (forspiral) {
            if(mActivity instanceof NeonLayout){
