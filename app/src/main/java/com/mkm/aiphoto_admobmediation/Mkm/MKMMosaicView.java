...
import com.mkm.aiphoto_admobmediation.Adapter.MosaicAdapter;
...
public class MKMMosaicView extends ImageView {
    ...
    public MKMMosaicView(Context context) {
        super(context);
        init();
    }

    public MKMMosaicView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public MKMMosaicView(Context context, AttributeSet attributeSet, int i) {
