...
public class MKMSplashSquareView extends AppCompatImageView {
    ...
    public MKMSplashSquareView(Context context) {
        super(context);
        init();
    }

    public MKMSplashSquareView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public MKMSplashSquareView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void addSticker(@NonNull final Sticker sticker2, final int i) {
        if (ViewCompat.isLaidOut(this)) {
            ...
            post(new Runnable() {
                public void run() {
                    MKMSplashSquareView.this.addStickerImmediately(sticker2, i);
                }
            });
        }
    }
