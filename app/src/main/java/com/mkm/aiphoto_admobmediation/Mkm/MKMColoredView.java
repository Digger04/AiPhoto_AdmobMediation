...
import com.mkm.aiphoto_admobmediation.Adapter.ColoredAdapter;
...
public class MKMColoredView extends ImageView {
    ...
    public MKMColoredView(Context context) {
        super(context);
        init();
    }

    public MKMColoredView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public MKMColoredView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_1 ||
                ...
                this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_16 ||
                this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_17 ||
                this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_18 ||
                this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_19) {
