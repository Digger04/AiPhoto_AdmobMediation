...
import com.mkm.aiphoto_admobmediation.Crop.Cubic;
import com.mkm.aiphoto_admobmediation.Crop.Easing;
import com.mkm.aiphoto_admobmediation.Drip.Graphic.FastBitmapDrawable;
import com.mkm.aiphoto_admobmediation.Drip.org.tensorflow.IDisposable;

public class MKMMotionViewTouchBase extends AppCompatImageView implements IDisposable {
    ...
    public MKMMotionViewTouchBase(Context context) {
        super(context);
        init();
    }

    public MKMMotionViewTouchBase(Context context, AttributeSet attributeSet) {
