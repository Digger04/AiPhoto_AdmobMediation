...
public class MKMTextView extends Sticker {

    private MKMText polishText;
    ...
    @NonNull
    public MKMTextView setAlpha(@IntRange(from = 0L, to = 255L) int paramInt) {
        this.textPaint.setAlpha(paramInt);
        return this;
    }

    public MKMTextView setBackgroundAlpha(int paramInt) {
        this.backgroundAlpha = paramInt;
        return this;
    }

    public MKMTextView setBackgroundBorder(int paramInt) {
        this.backgroundBorder = paramInt;
        return this;
    }

    public MKMTextView setBackgroundColor(int paramInt) {
        this.backgroundColor = paramInt;
        return this;
    }


    public MKMTextView setDrawable(@NonNull Drawable paramDrawable) {
        this.drawable = paramDrawable;
        return this;
    }


    public MKMTextView setPaddingWidth(int paramInt) {
        this.paddingWidth = paramInt;
        return this;
    }


    public MKMTextView setShowBackground(boolean paramBoolean) {
        this.isShowBackground = paramBoolean;
        return this;
    }

    @NonNull
    public MKMTextView setText(@Nullable String paramString) {
        this.text = paramString;
        return this;
    }

    @NonNull
    public MKMTextView setTextAlign(@NonNull int paramInt) {
        switch (paramInt) {
            case 2:
    ...
    public MKMTextView setTextAlpha(int paramInt) {
        this.textAlpha = paramInt;
        return this;
    }

    @NonNull
    public MKMTextView setTextColor(@ColorInt int paramInt) {
        this.textColor = paramInt;
        return this;
    }

    public MKMTextView setTextHeight(int paramInt) {
        this.textHeight = paramInt;
        return this;
    }

    public MKMTextView setTextShadow(MKMText.TextShadow paramTextShadow) {
        this.textShadow = paramTextShadow;
        return this;
    }

    @NonNull
    public MKMTextView setTextShare(@Nullable Shader paramShader) {
        this.textPaint.setShader(paramShader);
        return this;
    }

    @NonNull
    public MKMTextView setTextSize(int paramInt) {
        this.textPaint.setTextSize(convertSpToPx(paramInt));
        return this;
    }

    public MKMTextView setTextWidth(int paramInt) {
        this.textWidth = paramInt;
        return this;
    }

    @NonNull
    public MKMTextView setTypeface(@Nullable Typeface paramTypeface) {
