...
import com.mkm.aiphoto_admobmediation.Draw.FilterImageView;
...
public class MKMView extends MKMStickerView implements ScaleGestureDetector.OnScaleGestureListener{
    ...
    public MKMView(Context context) {
        super(context);
        init(context);
    }

    public MKMView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init(attributeSet);
    }

    public MKMView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (this.imageGLSurfaceView.getImageHandler() != null) {
            ...
            this.imageGLSurfaceView.setSurfaceCreatedCallback(new ImageGLSurfaceView.OnSurfaceCreatedCallback() {
                public void surfaceCreated() {
                    MKMView.this.imageGLSurfaceView.setImageBitmap(bitmap);
                }
            });
        }
