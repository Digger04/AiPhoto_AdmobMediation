...
public class MKMSplashSticker extends Sticker {
    private Bitmap bitmapOver;
    private Bitmap bitmapXor;
    private Paint over;
    private Paint xor = new Paint();

    public MKMSplashSticker(Bitmap paramBitmap1, Bitmap paramBitmap2) {
    ...
    @NonNull
    public MKMSplashSticker setAlpha(@IntRange(from = 0L, to = 255L) int paramInt) {
        return this;
    }

    public MKMSplashSticker setDrawable(@NonNull Drawable paramDrawable) {
        return this;
    }
}
