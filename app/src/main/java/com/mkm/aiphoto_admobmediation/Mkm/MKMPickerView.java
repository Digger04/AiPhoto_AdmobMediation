...
import com.mkm.aiphoto_admobmediation.Activity.PhotoPickerActivity;
import com.mkm.aiphoto_admobmediation.Picker.PermissionsUtils;

import java.util.ArrayList;

public class MKMPickerView {
    ...
    public static class PhotoPickerBuilder {
        ...
        public void start(@NonNull Context context, @NonNull Fragment fragment) {
            if (PermissionsUtils.checkReadStoragePermission(fragment.getActivity())) {
                fragment.startActivityForResult(getIntent(context), MKMPickerView.REQUEST_CODE);
            }
        }
        ...
        public void start(@NonNull Activity activity) {
            start(activity, (int) MKMPickerView.REQUEST_CODE);
        }

        public PhotoPickerBuilder setPhotoCount(int i) {
            this.mPickerOptionsBundle.putInt(MKMPickerView.EXTRA_MAX_COUNT, i);
            return this;
        }

        public PhotoPickerBuilder setGridColumnCount(int i) {
            this.mPickerOptionsBundle.putInt(MKMPickerView.EXTRA_GRID_COLUMN, i);
            return this;
        }

        public PhotoPickerBuilder setShowGif(boolean z) {
            this.mPickerOptionsBundle.putBoolean(MKMPickerView.EXTRA_SHOW_GIF, z);
            return this;
        }

        public PhotoPickerBuilder setShowCamera(boolean z) {
            this.mPickerOptionsBundle.putBoolean(MKMPickerView.EXTRA_SHOW_CAMERA, z);
            return this;
        }

        public PhotoPickerBuilder setSelected(ArrayList<String> arrayList) {
            this.mPickerOptionsBundle.putStringArrayList(MKMPickerView.EXTRA_ORIGINAL_PHOTOS, arrayList);
            return this;
        }

        public PhotoPickerBuilder setForwardMain(boolean z) {
            this.mPickerOptionsBundle.putBoolean(MKMPickerView.MAIN_ACTIVITY, z);
            return this;
        }

        public PhotoPickerBuilder setPreviewEnabled(boolean z) {
            this.mPickerOptionsBundle.putBoolean(MKMPickerView.EXTRA_PREVIEW_ENABLED, z);
            return this;
        }
    }
}
