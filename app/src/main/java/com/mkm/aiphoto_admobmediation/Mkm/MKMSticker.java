...
public class MKMSticker extends Sticker {
    ...
    public MKMSticker(Context paramContext, int paramInt, Drawable paramDrawable) {
    ...
    @NonNull
    public MKMSticker setAlpha(@IntRange(from = 0L, to = 255L) int paramInt) {
        this.drawable.setAlpha(paramInt);
        return this;
    }

    public MKMSticker setDrawable(@NonNull Drawable paramDrawable) {
        return this;
    }
