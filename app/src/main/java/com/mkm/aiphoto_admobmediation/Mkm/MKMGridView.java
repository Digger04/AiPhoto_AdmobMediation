...
import com.mkm.aiphoto_admobmediation.Ultils.MatrixUtils;
...
public class MKMGridView extends MKMStickerView {
    ...
    public interface onQueShotSelectedListener {
        void onQuShotSelected(PolishGrid quShotCollage, int i);
    }
    ...
    public MKMGridView(Context context) {
        this(context, null);
    }

    public MKMGridView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public MKMGridView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.switchToSwapAction = new Runnable() {
            public void run() {
                if (MKMGridView.this.canSwap) {
                    MKMGridView.this.actionMode = ActionMode.SWAP;
                    MKMGridView.this.invalidate();
                }
            }
        };
    ...
    public void updateLayout(PolishLayout quShotLayout) {
        ...
        for (PolishGrid drawable : arrayList) {
    ...
    public MKMGridView setOnQueShotSelectedListener(onQueShotSelectedListener onQueShotSelectedListener) {
