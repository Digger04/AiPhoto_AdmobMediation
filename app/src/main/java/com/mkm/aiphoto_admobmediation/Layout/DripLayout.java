...
import com.mkm.aiphoto_admobmediation.Adapter.DripAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.DripBackgroundAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.DripColorAdapter;
import com.mkm.aiphoto_admobmediation.Assets.BrushColorAsset;
import com.mkm.aiphoto_admobmediation.Crop.MLCropAsyncTask;
import com.mkm.aiphoto_admobmediation.Crop.MLOnCropTaskCompleted;
import com.mkm.aiphoto_admobmediation.Drip.Imagescale.TouchListener;
import com.mkm.aiphoto_admobmediation.Eraser.StickerEraseActivity;
import com.mkm.aiphoto_admobmediation.Listener.BackgroundItemListener;
import com.mkm.aiphoto_admobmediation.Listener.LayoutItemListener;
import com.mkm.aiphoto_admobmediation.Listener.MultiTouchListener;
...
public class DripLayout extends BaseActivity implements LayoutItemListener, BackgroundItemListener,
    ...
    private MKMDripView dripViewImage;
    private DripFrameLayout frameLayoutBackground;
    private MKMDripView dripViewBackground;
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.findViewById(R.id.relativeLayoutStyle).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
        ...
        this.findViewById(R.id.relativeLayoutEraser).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
        ...
        this.findViewById(R.id.relativeLayoutBackground).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
    ...
    private void initBitmap() {
        if (faceBitmap != null) {
            selectedBitmap = com.mkm.aiphoto_admobmediation.Ultils.ImageUtils.getBitmapResize(DripLayout.this, faceBitmap, 1024, 1024);
    ...
    public void setStartDrip() {
        ...
        new MLCropAsyncTask(new MLOnCropTaskCompleted() {
            public void onTaskCompleted(Bitmap bitmap, Bitmap bitmap2, int left, int top) {
                ...
                cutBitmap = com.mkm.aiphoto_admobmediation.Ultils.ImageUtils.getMask(DripLayout.this, selectedBitmap, createBitmap, width, height);
