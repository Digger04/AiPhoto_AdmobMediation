...
import com.mkm.aiphoto_admobmediation.Adapter.ArtAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.ArtColorAdapter;
...
public class ArtLayout extends BaseActivity implements LayoutItemListener,
    ...
    public int count = 0;
    private MKMDripView dripViewFront;
