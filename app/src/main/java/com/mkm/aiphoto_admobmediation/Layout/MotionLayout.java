...
import com.mkm.aiphoto_admobmediation.Crop.CropAsyncTask;
import com.mkm.aiphoto_admobmediation.Eraser.StickerEraseActivity;
import com.mkm.aiphoto_admobmediation.Mkm.MKMMotionView;
...
import com.mkm.aiphoto_admobmediation.Ultils.MotionUtils;
...
public class MotionLayout extends BaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.imageViewCenter = (MKMMotionView) findViewById(R.id.imageViewTouch);
        ...
        this.imageViewCenter.setDisplayType(MKMMotionView.DisplayType.FIT_TO_SCREEN);
        ...
        this.findViewById(R.id.image_view_compare_eraser).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                StickerEraseActivity.b = imageBitmap;
