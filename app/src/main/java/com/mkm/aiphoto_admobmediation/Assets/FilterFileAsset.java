package com.mkm.aiphoto_admobmediation.Assets;
...
public class FilterFileAsset {
    ...
    public static final FiltersCode[] FILTERS = {
            ...
            new FiltersCode("@adjust lut filter/tone_9.webp", "TN-9"),
            new FiltersCode("@adjust lut filter/tone_10.webp", "TN-10"),
            new FiltersCode("@adjust lut filter/tone_11.webp", "TN-11"),
            new FiltersCode("@adjust lut filter/tone_12.webp", "TN-12"),
            ////
