...
public class ShadowAdapter extends RecyclerView.Adapter<ShadowAdapter.ViewHolder> {
    ...
    private List<MKMText.TextShadow> lstTextShadows;
    ...
    public ShadowAdapter(Context context2, List<MKMText.TextShadow> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        int i2;
        MKMText.TextShadow textShadow = this.lstTextShadows.get(i);
