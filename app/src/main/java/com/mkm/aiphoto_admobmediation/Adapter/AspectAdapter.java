...
import com.mkm.aiphoto_admobmediation.Model.RatioModel;
...
public class AspectAdapter extends RecyclerView.Adapter<AspectAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        try {
            if (MKMCollageActivity.numberratio > 0 ) {
                AspectAdapter.this.selectedRatio = AspectAdapter.this.ratios.get(MKMCollageActivity.numberratio);
                AspectAdapter.this.lastSelectedView = MKMCollageActivity.numberratio;
        ...
        public void onClick(View view) {
            if (AspectAdapter.this.lastSelectedView != getAdapterPosition()) {
                ...
                if (getAdapterPosition() > 0) {
                    MKM.number_ratio = getAdapterPosition();
                }
