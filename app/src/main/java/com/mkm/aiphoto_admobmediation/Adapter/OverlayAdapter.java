        ...
        ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    OverlayAdapter.this.hardmixListener.onOverlaySelected(selectIndex,((OverlayFileAsset.OverlayCode) OverlayAdapter.this.effectsCodeList.get(OverlayAdapter.this.selectIndex)).getImage());
