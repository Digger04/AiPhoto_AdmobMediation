...
public class FrameGradientAdapter extends RecyclerView.Adapter<FrameGradientAdapter.ViewHolder> {
    ...
    public FrameGradientAdapter(Context context, FrameListener frameListener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            FrameGradientAdapter.this.frameListener.onBackgroundSelected((SquareView) FrameGradientAdapter.this.squareViewList.get(FrameGradientAdapter.this.selectedSquareIndex));
