...
public class AdjustAdapter extends RecyclerView.Adapter<AdjustAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (this.selectedIndex == i) {
            ...
            viewHolder.text_view_adjust_name.setTextColor(ContextCompat.getColor(context, R.color.black));
            viewHolder.image_view_adjust_icon.setColorFilter(ContextCompat.getColor(context, R.color.black));
        }
    }
