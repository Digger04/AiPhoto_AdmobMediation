...
public class PermissionsUtils {
    public static boolean checkReadStoragePermission(Activity activity) {
        ...
        if (!z) {
            ActivityCompat.requestPermissions(activity, PermissionConstant.PERMISSIONS_EXTERNAL_READ, 2);
        }
        return z;
    }
    ...
    public static boolean checkWriteStoragePermission(Fragment fragment) {
        ...
        if (!z) {
            fragment.requestPermissions(PermissionConstant.PERMISSIONS_EXTERNAL_WRITE, 3);
        }
        return z;
    }
    ...
    public static boolean checkCameraPermission(Fragment fragment) {
        ...
        if (!z) {
            fragment.requestPermissions(PermissionConstant.PERMISSIONS_CAMERA, 1);
        }
        return z;
    }
    ...
    public static boolean checkCameraPermission(Activity activity) {
        ...
        if (!z) {
            ActivityCompat.requestPermissions(activity, PermissionConstant.PERMISSIONS_CAMERA, 1);
        }
        return z;
    }
    ...
    public static boolean checkWriteStoragePermission(Activity activity) {
        ...
        if (!z) {
            ActivityCompat.requestPermissions(activity, PermissionConstant.PERMISSIONS_EXTERNAL_WRITE, 3);
        }
        return z;
    }
}
