...
public class MKMCarouselPicker extends ViewPager {
    ...
    public MKMCarouselPicker(Context context2) {
        this(context2, (AttributeSet) null);
        this.context = context2;
    }

    public MKMCarouselPicker(Context context2, AttributeSet attributeSet) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        setPageMargin((-getMeasuredWidth()) +
                SystemUtil.dpToPx(this.context, this.itemWidth));
    }
