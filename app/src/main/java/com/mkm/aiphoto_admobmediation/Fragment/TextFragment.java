...
import com.mkm.aiphoto_admobmediation.Adapter.FontAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.ShadowAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.TetxBackgroundAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.TetxColorAdapter;
import com.mkm.aiphoto_admobmediation.Assets.FontFileAsset;
import com.mkm.aiphoto_admobmediation.MKM;
import com.mkm.aiphoto_admobmediation.Mkm.MKMEditText;
import com.mkm.aiphoto_admobmediation.Mkm.MKMText;
import com.mkm.aiphoto_admobmediation.Picker.MKMCarouselPicker;
...
public class TextFragment extends DialogFragment implements View.OnClickListener, FontAdapter.ItemClickListener,
    ...
    public List<MKMCarouselPicker.PickerItem> colorItems;
    ...
    MKMEditText add_text_edit_text;
    ...
    public List<MKMCarouselPicker.PickerItem> textTextureItems;
    MKMCarouselPicker texture_carousel_picker;
    SeekBar textColorOpacity;

    public interface TextEditor {
        void onBackButton();
        void onDone(MKMText polishText);
    }
    ...
    public static TextFragment show(@NonNull AppCompatActivity appCompatActivity, MKMText addTextProperties) {
    ...
    public void onShadowItemClick(View view, int i) {
        MKMText.TextShadow textShadow = MKMText.getLstTextShadow().get(i);
    ...
    public void setPolishText(MKMText polishText) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle bundle) {
        ...
        if (this.polishText == null) {
            this.polishText = MKMText.getDefaultProperties();
        }
        ...
        this.shadowAdapter = new ShadowAdapter(getContext(), MKMText.getLstTextShadow());
        this.shadowAdapter.setClickListener(this);
        this.recycler_view_shadow.setAdapter(this.shadowAdapter);
        this.texture_carousel_picker.setAdapter(new MKMCarouselPicker.CarouselViewAdapter(getContext(), this.textTextureItems, 0));
        ...
        this.add_text_edit_text.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                ...
                MKM.text = charSequence.toString();
        ...
        try {
            if (MKMCollageActivity.text_add.length() >0) {
    ...
    private void CloseSave() {
        TextFragment.this.polishText.setText(MKMCollageActivity.text_add);
    ...
    public void initView(View view) {
        ...
        TextFragment.this.text_view_preview_effect.setText(MKMCollageActivity.text_add);
        TextFragment.this.add_text_edit_text.setText(MKMCollageActivity.text_add);
...
//        this.textViewShadow.setOnClickListener(this);
    ...
    private void Click_textViewShadow() {
        textViewShadow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                textViewShadow.setTextColor(getResources().getColor(R.color.mainColor));
                textViewFont.setTextColor(getResources().getColor(R.color.white));
                recycler_view_fonts.setVisibility(View.GONE);
                recycler_view_shadow.setVisibility(View.VISIBLE);
            }
        });
    }

    private void Click_textViewFont() {
        textViewFont.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                textViewShadow.setTextColor(getResources().getColor(R.color.white));
                textViewFont.setTextColor(getResources().getColor(R.color.mainColor));
                recycler_view_fonts.setVisibility(View.VISIBLE);
                recycler_view_shadow.setVisibility(View.GONE);
            }
        });
    }
...
//                return;
    ...
    public List<MKMCarouselPicker.PickerItem> getTextTextures() {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < 42; i++) {
            try {
                AssetManager assets = getContext().getAssets();
                arrayList.add(new MKMCarouselPicker.DrawableItem(Drawable.createFromStream(assets.open("texture/texture_" + (i + 1) + ".webp"), (String) null)));
            } catch (Exception e) {
            }
        }
        return arrayList;
    ...
    public List<MKMCarouselPicker.PickerItem> getColorItems() {
        ArrayList arrayList = new ArrayList();
        //FREE
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFFFFF"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#BBBBBB"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#4E4E4E"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#212121"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#000000"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFD7CD"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#F9AB9D"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#EC5C60"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#CB3243"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#CD181F"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FF0000"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFF2CA"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FDE472"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#F3AF59"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FC7F3D"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#ED3F0F"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFF1F1"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFE1E4"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFA4B9"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FF679F"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FB2C78"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#E7D5E7"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#D3A6D8"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#BA66AF"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#A53B8E"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#65218C"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#99D2F9"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#81ADEA"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#2961A9"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#0E2E89"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#171982"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#A5E7F6"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#7CE3FF"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#00B0D0"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#058BC0"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#08447E"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#DEEEE9"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#B3D0C5"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#4DAF9D"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#21887C"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#0F664E"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#D3E5A6"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#AACE87"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#A3AF38"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#6D822B"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#366131"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#E4D9C0"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#D6C392"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#A3815A"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#72462F"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#3E3129"));
        //PRO 1
        arrayList.add(new MKMCarouselPicker.ColorItem("#A7A7A7"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#995452"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#E1D6D7"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#CCBFD4"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#A67C80"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#D4D3CF"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#7A7185"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#6E5055"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#666563"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#F0E4FB"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#EED0D5"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#E1CCD1"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#C3C9DF"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#929493"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#807D5C"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#E2E4E1"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#8596A4"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#ECECEC"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#96A48C"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#AFB0B2"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#BEC0BF"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#B7C5B3"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#A0A7BA"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFFAF7"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#7D8970"));
        //PRO 2
        arrayList.add(new MKMCarouselPicker.ColorItem("#FF7063"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FF3274"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#3EA2D7"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFA258"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#F22D52"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#F2A0B6"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#7285F2"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#3ADB7C"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#F2C4CD"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#129AEF"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#0278A6"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#0D8C39"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#5639A5"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#A482F4"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#4AE3D2"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#00D28E"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FA4848"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#730068"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#729D38"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#C6E377"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#022D3C"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#900C3F"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FF5733"));
        arrayList.add(new MKMCarouselPicker.ColorItem("#FFC300"));
        return arrayList;
    }
}
