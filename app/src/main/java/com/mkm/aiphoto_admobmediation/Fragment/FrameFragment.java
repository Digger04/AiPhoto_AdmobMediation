...
import com.mkm.aiphoto_admobmediation.Adapter.FrameColorAdapter;
import com.mkm.aiphoto_admobmediation.Adapter.FrameGradientAdapter;
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        inflate.findViewById(R.id.relativeLayoutColor).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                textViewColor.setTextColor(getResources().getColor(R.color.black));
        ...
        inflate.findViewById(R.id.relativeLayoutGradient).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                textViewGradient.setTextColor(getResources().getColor(R.color.black));
